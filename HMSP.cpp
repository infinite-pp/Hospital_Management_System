...
string doctor::getSpec(){
    ...
    cout<<"7.FORENSIC_MEDICINE " << endl;
    cout<<"8.DERMATOLOGY" << endl;
    cout<<"9.CARDIOLOGY " << endl;
    cout<<"10.ANAESTHESIOLOGY " << endl;
    cout<<"11.OPHTHALMOLOGY " << endl;
    cout<<"12.VIROLOGY " << endl;
    cout<<"13.ORTHOPAEDICS " << endl;
	int s;
	cin>>s;
	switch(s){
		case 1:{
...
string patient::getDept(){
    ...
    cout<<"11.OPHTHALMOLOGY " << endl;
    cout<<"12.VIROLOGY " << endl;
    cout<<"13.ORTHOPAEDICS " << endl << endl;
	int s;
	cin>>s;
	switch(s){
...
int main(){
    ...
    system("cls");
	cout<<endl;
	cout<<right<<setw(60)<<setfill(' ')<<"WELCOME TO QUINARY'S HOSPITAL MANAGEMENT SYSTEM "<<endl;
	cout<<endl<<endl;
